...
/**
 * TestEntityConstructorParams
 *
 * @ORM\Table(name="test_entity_constructor_params")
 * @ORM\Entity(repositoryClass="Ordermind\LogicalAuthorizationDoctrineORMBundle\Tests\Fixtures\Repository\Misc\TestEntityConstructorParamsRepository")
 */
class TestEntityConstructorParams
{
    /**
     * @var int
     *
