 ...
 * TestEntityAbortSave
 *
 * @ORM\Table(name="test_entity_abort_save")
 * @ORM\Entity(repositoryClass="Ordermind\LogicalAuthorizationDoctrineORMBundle\Tests\Fixtures\Repository\Misc\TestEntityAbortSaveRepository")
 */
class TestEntityAbortSave
{
    /**
     * @var int
     *
